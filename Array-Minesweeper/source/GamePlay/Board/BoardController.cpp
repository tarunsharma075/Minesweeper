...
namespace Gameplay
{
	...
	namespace Board
	{
		...
		void BoardController::processMineCells(sf::Vector2i cellposition)
		{
			ServiceLocator::getInstance()->getGameplayService()->endgame(Gameplay::GameResult::LOST);
